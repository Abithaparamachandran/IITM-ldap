...
if ($ldapbind) {
 ...
 $search_base[]="ou=faculty,ou=People,dc=ldap,dc=iitm,dc=ac,dc=in";
 $search_base[]="ou=staff,ou=People,dc=ldap,dc=iitm,dc=ac,dc=in";
